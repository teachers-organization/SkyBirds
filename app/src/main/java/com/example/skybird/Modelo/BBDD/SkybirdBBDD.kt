...
abstract class SkybirdBBDD : RoomDatabase() {
    ...
    companion object {
        ...
        private var Instance: SkybirdBBDD? =
            null //The Instance variable keeps a reference to the database, when one has been created
        ...
        fun getDatabase(context: Context): SkybirdBBDD {
            return Instance ?: synchronized(this) {
                Room.databaseBuilder(context, SkybirdBBDD::class.java, "SkybirdBBDD")
