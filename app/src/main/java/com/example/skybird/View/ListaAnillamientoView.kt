...
@Composable
fun ListaAnillamiento(skybirdDAO: SkybirdDAO, volver: () -> Unit, sesionViewModel: SesionViewModel, avistamientoViewModel: AvistamientoViewModel, nuevoAnilla: () -> Unit){
...
/*
@Composable
fun MostrarAnillas(skybirdDAO: SkybirdDAO, navDetPregunta: () -> Unit, filtrarTitulo: String) {
